...
\begin{abstract}
  ...
  view scalar fields by coloring surfaces and volumes.  Unfortunatly, the
  ...
  The rainbow color map, which na\"{i}vely sweeps through the most
  saturated colors that a display can reproduce in rainbow color order, is
  well known for its abilities to obscure data, introduce artifacts, and
  confuse users.

  Although many other color maps have been proposed and used, none have
  been adopted by the visualization community as a default in scientific
  visualization.  In this paper, we explore the use of diverging color maps
