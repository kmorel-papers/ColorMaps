...
%% Table~\ref{table:Cool2WarmRGB} gives example
...
visualization requirements outlined in
Section~\ref{sec:ColorMapRequriements}.  The colors are aesthetically
...
minimally interferes with shading.  Figure~\ref{fig:MapComparison} compares
the cool-warm color map to some common alternatives as well as some
recommended by Rheingans\scite{Rheingans99} and Ware\scite{Ware04}.
