...
with dichromatic vision.  \sticky{low, middle, high}
...
Clearly Equation~\ref{eqn:s_linear_uniform} resolve to a constant and
...
dashed lines).  We can correct for this problem by reducing $M$ at each
end, but this adds the problem that colors will change faster near white
when $M$ is larger.
