...
\begin{figure}
  ...
  \caption{Isoluminant color maps.  The green to red color map is popular
    ...
    vision. \sticky{Fix Isoluminant colors.}}
...
\begin{figure}
  ...
  \caption{Using piecewise linear interpolations in \Lab color space causes
    ...
    transition can be softened by interpolating in \Msh space (right
    image).\sticky{Fix to new colors.}}
...
\begin{figure}
  ...
  \caption{A continuous diverging color map that is well suited to scientific
    visualization. \sticky{Set to new color map.}}
...
\begin{figure*}
  ...
  \caption{Comparison of color map effectiveness.  The color maps are, from
    ...
    Vischeck), and 3D shading.  \sticky{Fix everything.}}
...
\begin{figure}
  ...
  \end{tabular}
  \caption{Further examples of color maps defined in \Msh space. \sticky{update}}
